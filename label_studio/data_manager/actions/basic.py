...
from webhooks.utils import emit_webhooks_for_instances
...
def delete_tasks(project, queryset, **kwargs):
    ...
    emit_webhooks_for_instances(project.organization, project, WebhookAction.TASK_DELETED, tasks_ids)
...
def delete_tasks_annotations(project, queryset, **kwargs):
    ...
    annotations.delete()
    emit_webhooks_for_instances(project.organization, project, WebhookAction.ANNOTATION_DELETED, annotations_ids)
